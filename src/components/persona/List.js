          ...
          <tbody>
            {items.map((item) => (
              <tr key={item.idPersona}>
                ...
                <td className="text-center">{item.idNivel}</td>
                <td className="text-center">{item.estado}</td>
                <td className="text-center">
                  <button
                    className="btn btn-warning py-0">
                    <Link className="text-dark text-decoration-none" to={`/EditPersona/${item.idPersona}`}>Editar</Link>
                  </button>{" "}
                </td>
                <td className="text-center">
                  <button
                    className="btn btn-danger py-0">
                    <Link className="text-white text-decoration-none" to={`/DelPersona/${item.idPersona}`}>Eliminar</Link>
                  </button>{" "}
                </td>
              </tr>
            ))}
