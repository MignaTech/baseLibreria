              ...
              <tr key={item.idCategoria}>
                ...
                <td className="text-center">
                  <button
                    ...
                    <Link className="text-dark text-decoration-none" to={`/editCategoria/${item.idCategoria}`}>Editar</Link>
                  </button>{" "}
                </td>
                <td className="text-center">
                  <button
                    className="btn btn-danger py-0">
                    <Link className="text-white text-decoration-none" to={`/DelCategoria/${item.idCategoria}`}>Eliminar</Link>
                  </button>{" "}
                </td>
              </tr>
            ))}
