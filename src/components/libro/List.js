...
class ListLibro extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    axios
      .get("http://localhost:5000/api/libro", {
        headers: {
              ...
              <tr key={item.idLibro}>
                ...
                <td className="text-center">
                  <button
                    ...
                    <Link className="text-dark text-decoration-none" to={`/EditLibro/${item.idLibro}`}>Editar</Link>
                  </button>{" "}
                </td>
                <td className="text-center">
                  <button
                    className="btn btn-danger py-0">
                    <Link className="text-white text-decoration-none" to={`/DelLibro/${item.idLibro}`}>Eliminar</Link>
                  </button>{" "}
                </td>
              </tr>
            ))}
